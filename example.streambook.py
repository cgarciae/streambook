...
__st.markdown(r"""# Streambook example""", unsafe_allow_html=True)
...
with __st.echo(), streambook.st_stdout('info'):
    ...
    import time
__st.markdown(r"""## Main Code""", unsafe_allow_html=True)
...
with __st.echo(), streambook.st_stdout('info'):
    ...
    print("Printing2", x)
    "Output", x
__st.markdown(r"""## Advanced Features""", unsafe_allow_html=True)
...
__st.markdown(r"""## Longer example""", unsafe_allow_html=True)
with __st.echo(), streambook.st_stdout('info'):
...
with __st.echo(), streambook.st_stdout('info'):
    ...
    fig
__st.markdown(r"""## Exporting to Jupyter""", unsafe_allow_html=True)
...
`jupytext --to notebook --execute example.notebook.py`""", unsafe_allow_html=True)
